...
class Settings:
    model: str = field(default_factory=lambda: os.getenv("GLINER2_MODEL", "fastino/gliner2-large-v1"))
    ...
    host: str = field(default_factory=lambda: os.getenv("GLINER2_HOST", "0.0.0.0"))
